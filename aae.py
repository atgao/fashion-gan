...
optimizer_G = torch.optim.Adam(
    itertools.chain(encoder.parameters(), decoder.parameters()), lr=LR, betas=(opt.b1, opt.b2)
)
...
# ----------
print(opt)
print("Saved Encoder to {}".format(save_model(model, epoch, "encoder")))
print("Saved Decoder to {}".format(save_model(model, epoch, "decoder")))
print("Saved Discriminator to {}".format(save_model(model, epoch, "discriminator")))